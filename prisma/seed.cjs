...
async function main() {
    ...
    await prisma.station.upsert({
        ...
        update: {},
        create: {
            nome_comercial: 'Sandrina & Mário, LDA',
            morada: 'Estrada Nacional 221',
            codigo_postal: '5225-103',
            localidade: 'Sendim',
            lat: 41.1579,
            lng: -8.6291,
            telefone: '273739700',
            email: 'geralsandrinaemario@hotmail.com',
            horario_semana: '07:00–22:00',
            horario_fim_semana: '07:00–22:00',
            feriados_especiais: 'Aberto em feriados nacionais',
            ...
            linksJson: JSON.stringify({
                ...
                whatsapp: 'https://wa.me/351938452320',
            }),
            logoUrl: '',
            heroUrl: '',
        },
